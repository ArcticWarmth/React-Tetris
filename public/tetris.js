...
function Tetris(controller) {
	...
	continueButton = new Button({image: 'continue.png', x: 250, y: 150});
	restartButton = new Button({image: 'restart.png', x: 250, y: 200});
...
window.onload = function () {
    ...
    jaws.assets.add('blueblock.png');
    jaws.assets.add('cyanblock.png');
    jaws.assets.add('greenblock.png');
    jaws.assets.add('orangeblock.png');
    jaws.assets.add('purpleblock.png');
    jaws.assets.add('redblock.png');
    jaws.assets.add('yellowblock.png');

    jaws.assets.add('greyblock.png');
    jaws.assets.add('emptyblock.png');

    jaws.assets.add('continue.png');
    jaws.assets.add('restart.png');

    jaws.assets.add('backdrop.png');
    jaws.assets.add('topbar.png');
